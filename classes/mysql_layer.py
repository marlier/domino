	...
	def connectDB(self):
		...
		try:
			...
			try:
				...
				c.execute(cmd)
				cmd = '''CREATE TABLE IF NOT EXISTS alerts (id INT PRIMARY KEY AUTO_INCREMENT, createDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, message TEXT, teams CHAR(50), ack INT NOT NULL DEFAULT 0, ackby INT NOT NULL DEFAULT 0, acktime TIMESTAMP, lastPageSent TIMESTAMP, lastEmailSent TIMESTAMP, tries INT NOT NULL DEFAULT 0, host CHAR(20), service CHAR(50), environment CHAR(20), colo CHAR(20), status INT NOT NULL DEFAULT 3, position INT NOT NULL DEFAULT 1, tags VARCHAR(255), remote_ip_address VARCHAR(45), UNIQUE active(environment,colo,host,service));'''
				c.execute(cmd)
				cmd = '''CREATE TABLE IF NOT EXISTS alerts_history (id INT PRIMARY KEY AUTO_INCREMENT, createDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, message TEXT, teams CHAR(50), ack INT NOT NULL DEFAULT 0, ackby INT NOT NULL DEFAULT 0, acktime TIMESTAMP, lastPageSent TIMESTAMP, lastEmailSent TIMESTAMP, tries INT NOT NULL DEFAULT 0, host CHAR(20), service CHAR(50), environment CHAR(20), colo CHAR(20), status INT NOT NULL DEFAULT 3, position INT NOT NULL DEFAULT 1, tags VARCHAR(255), remote_ip_address VARCHAR(45));'''
				c.execute(cmd)
